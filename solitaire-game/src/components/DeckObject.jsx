...
export const DeckObject = () => {
  ...
  const deck = [
    // SPADES
    new Card('SPADES', 'BLACK', 1, spadesAce),
    new Card('SPADES', 'BLACK', 2, spades2),
    new Card('SPADES', 'BLACK', 3, spades3),
    new Card('SPADES', 'BLACK', 4, spades4),
    new Card('SPADES', 'BLACK', 5, spades5),
    new Card('SPADES', 'BLACK', 6, spades6),
    new Card('SPADES', 'BLACK', 7, spades7),
    new Card('SPADES', 'BLACK', 8, spades8),
    new Card('SPADES', 'BLACK', 9, spades9),
    new Card('SPADES', 'BLACK', 10, spades10),
    new Card('SPADES', 'BLACK', 11, spadesJack),
    new Card('SPADES', 'BLACK', 12, spadesQueen),
    new Card('SPADES', 'BLACK', 13, spadesKing),

    // DIAMONDS
    new Card('DIAMONDS', 'RED', 1, diamondsAce),
    new Card('DIAMONDS', 'RED', 2, diamonds2),
    new Card('DIAMONDS', 'RED', 3, diamonds3),
    new Card('DIAMONDS', 'RED', 4, diamonds4),
    new Card('DIAMONDS', 'RED', 5, diamonds5),
    new Card('DIAMONDS', 'RED', 6, diamonds6),
    new Card('DIAMONDS', 'RED', 7, diamonds7),
    new Card('DIAMONDS', 'RED', 8, diamonds8),
    new Card('DIAMONDS', 'RED', 9, diamonds9),
    new Card('DIAMONDS', 'RED', 10, diamonds10),
    new Card('DIAMONDS', 'RED', 11, diamondsJack),
    new Card('DIAMONDS', 'RED', 12, diamondsQueen),
    new Card('DIAMONDS', 'RED', 13, diamondsKing),

    // CLUBS
    new Card('CLUBS', 'RED', 1, clubsAce),
    new Card('CLUBS', 'RED', 2, clubs2),
    new Card('CLUBS', 'RED', 3, clubs3),
    new Card('CLUBS', 'RED', 4, clubs4),
    new Card('CLUBS', 'RED', 5, clubs5),
    new Card('CLUBS', 'RED', 6, clubs6),
    new Card('CLUBS', 'RED', 7, clubs7),
    new Card('CLUBS', 'RED', 8, clubs8),
    new Card('CLUBS', 'RED', 9, clubs9),
    new Card('CLUBS', 'RED', 10, clubs10),
    new Card('CLUBS', 'RED', 11, clubsJack),
    new Card('CLUBS', 'RED', 12, clubsQueen),
    new Card('CLUBS', 'RED', 13, clubsKing),

    // HEARTS
    new Card('HEARTS', 'RED', 1, heartsAce),
    new Card('HEARTS', 'RED', 2, hearts2),
    new Card('HEARTS', 'RED', 3, hearts3),
    new Card('HEARTS', 'RED', 4, hearts4),
    new Card('HEARTS', 'RED', 5, hearts5),
    new Card('HEARTS', 'RED', 6, hearts6),
    new Card('HEARTS', 'RED', 7, hearts7),
    new Card('HEARTS', 'RED', 8, hearts8),
    new Card('HEARTS', 'RED', 9, hearts9),
    new Card('HEARTS', 'RED', 10, hearts10),
    new Card('HEARTS', 'RED', 11, heartsJack),
    new Card('HEARTS', 'RED', 12, heartsQueen),
    new Card('HEARTS', 'RED', 13, heartsKing),
  ];
  console.log(deck);
  return (
